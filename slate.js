...
S.bnda({
    ...
    "up:ctrl;alt;cmd"     : topHalf,
    "down:ctrl;alt;cmd"   : bottomHalf,
    "left:ctrl;shift;cmd" : leftTop,
    "up:ctrl;shift;cmd"   : rightTop,
    "down:ctrl;shift;cmd" : leftBottom,
    "right:ctrl;shift;cmd": rightBottom,
